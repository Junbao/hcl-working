        ...
        $("ul.slick-dots").each(function () {
            ...
            $(this)
                ...
                .each(function () {
                    ...
                    $(this)
                        .find("button")
                        .attr("aria-label", fullariatext);
                    $(this)
                        .find("button")
                        .attr("title", fullariatext); /*341792*/
                });
        });
    }, 100);
}
$(window).load(function () {
    ...
    /*ImageTabcarousel */
    $(
        ".cp-image-tab-carousel .carousel-thumbnails .carousel-thumbnail-item"
    ).each(function () {
        var _currentId = $(this).attr("id");
        var _currentIndex = $(this).index();
        $(".cp-image-tab-carousel .carousel-content-item")
            .eq(_currentIndex)
            .attr("aria-labelledby", _currentId);
    });
});
...
$(document).ready(function () {
    if ($("body").hasClass("fr-be")) {
        $(".CP_tryBuyFilter1 .filterlinks li").each(function () {
            $(this)
                .find("a.TryBuyFilter1")
                .attr("ms.ea_action", "ntd");
            $(this)
                .find("a.TryBuyFilter1")
                .removeAttr("ms.ea_offer");
        });
    }
});
...
$(document).ready(function () {
    ...
    $(".hero-carousel").each(function () {
        ...
        if ($(this).attr("data-auto-play") == "true") {
            autoplay = true;
            if (
                $(this).attr("data-auto-play-speed") != undefined &&
                $(this).attr("data-auto-play-speed") != null &&
                $(this).attr("data-auto-play-speed") != ""
            ) {
...
$(document).ready(function () {
    if ($(".cp-sidevideo-with-copy.text-on-left") != null) {
        var $holder = $(".cp-sidevideo-with-copy")
            .children()
            .find(".copy-section")
            .clone();
        $(".cp-sidevideo-with-copy .livearea").append($holder);
        $(".cp-sidevideo-with-copy")
            .find(".livearea")
            .children(":last")
            .addClass("mobile");
    }
...
function contentHeight() {
    ...
    setTimeout(function () {
        $(".cp-sidevideo-with-copy").each(function () {
            $(this)
                .find(".side-video-carousel .content .caption-text")
                .each(function () {
                    var anchorHeight = $(this).height();
                    maxAnchorHeight =
                        maxAnchorHeight > anchorHeight ? maxAnchorHeight : anchorHeight;
                });
            $(this)
                .find(".side-video-carousel .content .caption-text")
    ...
    try {
        ...
        setTimeout(function () {
            $("#CP_FourReasons_1 .carousel-items .carousel-item").each(function () {
                ...
                maxHeight =
                    maxHeight > carouselItemHeight ? maxHeight : carouselItemHeight;
            });
            $("#CP_FourReasons_1 .carousel-items .carousel-item").css(
                "height",
                maxHeight
            );
        }, 100);
    ...
    try {
        $("table").each(function () {
            ...
            $(currentTable)
                .find("tr:odd")
                .find("td")
                .addClass(oddRowBgColor);
            $(currentTable)
                .find("tr:even")
                .find("td")
                .addClass(evenRowBgColor);
            $(currentTable)
                .find("tr:even")
                .find("th[scope=row]")
                .addClass(evenRowBgColor);
        ...
        $(".stage-content .main-table-container.text-on-left")
            .find(".left-container")
            .remove();
        $(".stage-content .main-table-container.text-on-right")
            ...
            $(this)
                ...
                .each(function () {
                    ...
                    var headheight = $(this)
                        .find("h3")
                        .outerHeight();
                    var anchorheight = $(this)
                        .find(".links a")
                        .outerHeight();
                    maxheadheight =
                        maxheadheight > headheight ? maxheadheight : headheight;
                    maxanchorheight =
                        maxanchorheight > anchorheight ? maxanchorheight : anchorheight;
                });
            $(this)
...
function initiateslickafterclick() {
    if (
        $(".currentsubtabs .tabdata.active").find(".carousel-wrapper").length > 0
    ) {
        if (
            !$(".currentsubtabs .tabdata.active")
                .find(".carousel-wrapper")
                .hasClass("slickCalled")
        ) {
            if (
                $(".currentsubtabs .tabdata.active")
                    .find(".carousel-wrapper")
            ...
            $(
                ".currentsubtabs .tabdata.active .cp_media_carousel_with_responsive"
            ).each(function () {
...
$(document).on("click", ".cp_subtab .tabs", function (e) {
    if (!$("body").hasClass("split-resource")) {
        ...
        $(this)
            .parents()
            .closest(".cpsubtabsconatiner")
            .addClass("currentsubtabs");
...
function fixpopupHeight() {
    ...
    var topval =
        $(".popup-overlay").height() / 2 - $(".panel-popup").height() / 2 + "px";
...
$(document).on("click", ".partner-icon", function (e) {
    if ($(this).attr("popup-hide") == "hide-popup") {
        ...
        var wholehtml = $(this)
            .parent()
            .find(".partner-full-details")
            .html();
        if (wholehtml == null || wholehtml == undefined || wholehtml == "") {
            return false;
        }

        var popup_bgcolor = $(this)
            .parent()
            .find(".partner-full-details")
            .attr("data-popup-bgcolor");
        var wholehtml = $(this)
            .parent()
            .find(".partner-full-details")
            .html();
...
$(document).ready(function () {
    try {
        if ($(".accordion").length) {
            ...
            var contentAreas = $(
                ".accordion-main-panel .ui-accordion-content "
            ).hide();
            var expandLink = $(".accordion-expandAll");
            var collapseLink = $(".accordion-collapseAll");
            var accordionTitleBgColor = $(".accordion-main-panel").attr(
                "data-accordion-title-bgcolor"
            );
            var accordionArrowClass = $(".accordion-main-panel").attr(
                "data-accordion-arrow-class"
            );
            ...
            if (
                accordionArrowClass != "" &&
                accordionArrowClass.toLowerCase() == "bg-right-arrow-white"
            ) {
                bgArrowColor = "white";
            }
            ...
            function activateAccordion(header) {
                ...
                if (isOpen) {
                    $(header)
                        .removeClass("bg-down-arrow-" + bgArrowColor)
                        .addClass("bg-right-arrow-" + bgArrowColor);
                    ...
                    $(header)
                        .removeClass("bg-right-arrow-" + bgArrowColor)
                        .addClass("bg-down-arrow-" + bgArrowColor);
            ...
            $(".accordionpanel").each(function () {
                if (
                    ...
                    $(this)
                        .find(".left-content")
                        .addClass("reset-left-column");
                    $(this)
                        .find(".right-content")
                        .addClass("reset-right-column");
                    $(this)
                        .find(".right-content")
                        .find(".image-holder")
                        .addClass("set-left-column");
                    $(this)
                        .find(".right-content")
                        .find(".button-holder")
                    ...
                    $(this)
                        .find(".right-content")
                        .addClass("decreased-right-column");
                    $(this)
                        .find(".right-content")
                        .find(".image-holder a")
                        .parent()
                    ...
                    $(this)
                        .find(".right-content")
                        .find(".button-holder")
                        .addClass("button-holder-max-width");
                    $(this)
                        .find(".left-content")
                        .addClass("increased-left-column");
                } else {
                    //One Column//
                    $(this)
                        .find(".right-content")
    ...
    try {
        $(".hero-carousel").each(function () {
            ...
            $(this)
                ...
                .each(function () {
                    if (
                        !$(this).hasClass("open-popup-video") &&
                        !$(this).hasClass("open-inline-video")
                    ) {
                        $(this).removeAttr("href");
...
$(window).on("load resize", function () {
    try {
        ...
        var head1_paraHeight = $(
            ".cp-TwoCol-BGColor .column-1 .c-heading-3"
        ).outerHeight();
        var head2_paraHeight = $(
            ".cp-TwoCol-BGColor .column-2 .c-heading-3"
        ).outerHeight();
...
var intraPageNavBar = (function () {
    ...
    function init() {
        ...
        intraPageNavBottomValue =
            $intraPageNav.offset().top + $intraPageNav.height();
            ...
            if (hrefValue) {
                ...
                if (bookmarkPosition >= 0) {
                    ...
                    if ($(id).length == 1) {
                        ...
                        $bookmark.padding = $($bookmark.id)
                            .children(":first")
                            .css("padding-top");
                        $bookmark.margin = $($bookmark.id)
                            .children(":first")
                            .css("margin-top");
                        $bookmark.dlpadding = $($bookmark.id)
                            .next()
                            .children(":first")
                            .css("padding-top");
                        ...
                        if (
                            !addStickyOnPageLoad &&
                            window.location.hash.toLowerCase() == $bookmark.id.toLowerCase()
                        ) {
        ...
        $(window).scroll(function () {
            ...
            if ($(window).scrollTop() > intraPageNavTopValue) {
                if (
                    $(window).scrollTop() >
                    Math.floor($($bookmarks[0].id).offset().top) -
                    intraPageNavHeight * 0.75
                ) {
                    addStickyBehaviour();
                } else {
                ...
                $(window).scrollTop() <
                Math.floor($($bookmarks[0].id).offset().top) - intraPageNavHeight * 1.05
            ) {
                removeStickyBehaviour();
            }
            $.each($bookmarks, function (index, element) {
                if (
                    element != null &&
                    $(window).scrollTop() >=
                    Math.floor($(element.id).offset().top - containerTop)
                ) {
                    deActivateAllNavBarLinks();
    ...
    function addStickyBehaviour() {
        if (!$intraPageNav.hasClass("sticky")) $intraPageNav.addClass("sticky");
    }

    function removeStickyBehaviour() {
        if ($intraPageNav.hasClass("sticky")) {
            $intraPageNav.removeClass("sticky");
            $("#CP_StaticMenu .nav-grid-container")
                .children("div:first")
    ...
    function adjustContainerPosition(element) {
        ...
        if (componentIdFlag) {
            ...
            $(element)
                .find("div a:first")
                .focus(); /*Bug: 343310*/
            $("#CP_StaticMenu.sticky .nav-grid-container")
                .children("div:first")
                .css("padding-bottom", "1px");
            $(element)
                .children(":first")
                .css("padding-top", _height + "px");
            setTimeout(function () {
                resetContainer = true;
            }, 500);
        } else {
    ...
    function adjustContainerPositionScroll(event, element, staticMenuPosition) {
        ...
        staticMenuOriginalPosition =
            $("#" + componentAboveStaticMenu).offset().top +
            $("#" + componentAboveStaticMenu).height();
        ...
        if (componentIdFlag) {
            ...
            if (
                $(window).scrollTop() <= staticMenuOriginalPosition &&
                $componentTarget == "#" + componentBelowStaticMenu
            ) {
                ...
                if ($("#CP_StaticMenu").hasClass("sticky")) {
                    ...
                    $("html, body").animate(
                        {
                            scrollTop:
                                $($componentTarget).offset().top - staticMenu_height * 2
                        },
                        1000
                    );
                }
            ...
            setTimeout(function () {
                var tabindexChecker = $($componentTarget)
                    .parent("div")
                    .find("a:first")
                    .attr("tabindex");
                var tempComponentTarget = $($componentTarget)
                    .parent("div")
                    .find("a:first");
                if (
                    typeof tabindexChecker !== typeof undefined &&
                    tabindexChecker !== false
                ) {
            ...
            if (
                ...
                $("html, body").animate(
                    {
                        scrollTop:
                            $("#" + $componentTarget).offset().top - staticMenu_height
                    },
                    1000
                );
            } else if ($(window).scrollTop() < staticMenuOriginalPosition) {
    ...
    function resetContainerPosition() {
        $.each($bookmarks, function (index, element) {
            $(element.id)
                .children(":first")
                .css("margin-top", $bookmarks[index].margin);
            $(element.id)
                .children(":first")
                .css("padding-top", $bookmarks[index].padding);
            $(element.id)
                .next()
                .children(":first")
                .css("padding-top", $bookmarks[index].dlpadding);
        });
...
function UHFResourcesMenuHighlighter() {
    ...
    if ($(".cp_subtab").length > 0) {
        $(
            "ul.c-menu-container.shell-category-top-level.shell-category-nav-wrapper .c-top-nav-item a"
        ).removeClass("current");
        cpSubTabNav.find(".tabs").each(function () {
            if ($(this).attr("data-resources") == "resources") {
                $(
                    "ul.c-menu-container.shell-category-top-level.shell-category-nav-wrapper .c-top-nav-item"
                ).each(function () {
                    var href = $(this)
                        .find("a")
                        .attr("href")
            ...
            if ($(this).attr("data-resources") == "resources") {
                $("#uhf-c-nav a.c-uhf-nav-link").each(function () {
                    var href = $(this)
                        ...
                        .split("/");
                    var thisHref = href.pop();
                    if (thisHref.indexOf("resources") > -1) $(this).addClass("current");
                });
                return false;
            }
        });
    ...
    try {
        ...
        $("#uhf-c-nav a").each(function (index, value) {
            ...
            if (uhfAnchorValue.indexOf("/cloud-platform/") > -1) {
                ...
                if (
                    pageFromUrl.toString().toLowerCase() ==
                    cpPageName.toString().toLowerCase()
                ) {
                    activeLinkObjId = $(value).attr("id");
                    $("#" + activeLinkObjId).addClass("current");
                    $("#" + activeLinkObjId)
                        .closest(".c-uhf-menu")
                        .addClass("currentParent");
                    $("#" + activeLinkObjId)
                        .parents("li.f-sub-menu")
                        .addClass("currentSubParent");
                }
...
function updateHeight(container, element) {
    ...
    if (container == ".cp-four-reasons-1") {
        //four-reasons Bug #336899 Fix By Nagaraju K;;
        slides = $(container)
            .find(".carousel-items")
            .find(".carousel-item");
    }
...
function alignPaginationButton() {
    ...
    if (browserZoomLevel == 200) {
        $(this)
            .find("ul.slick-dots")
            .css("padding-bottom", "-61px !important");
    }
}
$(window).resize(function () {
    alignPaginationButton();
...
$(window).resize(function () {
    if ($(window).width() < 900) {
        $(".shell-category-header #shell-cat-header-logo-mobile").css(
            "display",
            "block"
        );
    } else {
...
function loadCortanaTab() {
    ...
    if (url.indexOf("#") != -1) {
        ...
        if ($(".cortana-6tabs").length > 0) {
            $(".cortana-6tabs .main-menu-ul")
                .find("li")
                .each(function () {
                    var deeplinkid = $(this)
                        .find("a")
                        .attr("data-deeplinkid")
                        .toLowerCase();
                    ...
                    $(this)
                        .parent()
                        .addClass("currentslicktab");

                    topvalue = $(".currentslicktab")
                        .parents()
                        .closest(".cortana-6tabs")
                        .offset().top;
                            ...
                            setTimeout(function () {
                                ...
                                $(" .tab-content.activeTab")
                                    ...
                                    .each(function () {
                                        count++;
                                        $(this)
                                            .parents("ul.inner-menu-ul")
                                            .addClass("subslicktab");
                                ...
                                if (
                                    submenu.parents("ul.inner-menu-ul").hasClass("slick-slider")
                                ) {
...
function updateCortanaUrl() {
    var mainTab = $(".cortana-6tabs")
        .find(".main-menu-ul")
        .find("li.current a")
        .attr("data-deeplinkid");
    var subTab = $(".cortana-6tabs")
        .find(".tab-content.activeTab")
        .find("li.current a")
        .attr("data-deeplinkid");
...
function slickInitializer() {
    ...
    $(
        ".cortana-6tabs.menu-container .slick-slider .slick-next, .menu-container .slick-slider .slick-prev"
    ).text("");
...
function slicksubInitializer() {
    ...
    if (
        ...
        $(".cortana-6tabs .inner-menu-ul li:first-child")
            ...
            .siblings()
            .removeClass("current");
        $(".cortana-6tabs .inner-tab-container .ms-grid > div:first-child")
            .addClass("activeTab")
            .siblings()
...
$(window).on("resize", function () {
    if ($(".cortana-6tabs").length > 0) {
        if (window.innerWidth < 768) {
            ...
            $(
                ".cortana-6tabs.menu-container .slick-slider .slick-next, .cortana-6tabs.menu-container .slick-slider .slick-prev"
            ).text("");
        }
    }
});
...
$(document).ready(function () {
    try {
        ...
        $("#cmwf_cortana_role .cortana-6tabs .main-menu-ul")
            .addClass("m-col-" + count_li * 4 + "-24")
            .addClass("m-col-24-push-" + (24 - count_li * 4) / 2);
        $(".cortana-6tabs .tab-container .tab-content ul").each(function () {
            var count_li1 = 0;

            $(this)
                .children("li.hide-by-default")
                .each(function () {
                    if (
                        $(this)
                            .find("p")
            ...
            if (count_li1 == 7) {
                ...
                $(this)
                    .children("li")
                    .addClass("col-1-" + count_li1);
                $(this).addClass("m-col-" + count_li1 * 4 + "-24");
            }
        });
        $(".cortana-6tabs .inner-tab-container .m-col-12-24:first-child").each(
            function () {
                if (
                    $(this)
                        .find("img")
        ...
        $(".cortana-6tabs .main-menu-ul li").on("click tap", function (e) {
            ...
            $(".cortana-6tabs .tab-container ." + clickedId)
                .addClass("activeTab")
                .siblings()
                .removeClass("activeTab");
        ...
        $(".cortana-6tabs .inner-menu-ul li").on("click tap", function (e) {
            ...
            $("." + parentId + " .inner-tab-container ." + clickedId)
                .addClass("activeTab")
                .siblings()
                .removeClass("activeTab");
        ...
        $(".cortana-6tabs .tab-container .inner-tab-container img").on(
            "click",
            function (e) {
                e.preventDefault();
                $(this)
        ...
        $(".cortana-6tabs .tab-container .inner-tab-container a").on(
            "click",
            function (e) {
        ...
        $(".cortana-6tabs .mscom-popup .mscom-popup-close-image").on(
            "click",
            function () {
        ...
        $(
            ".menu-container .inner-tab-container .m-col-12-24.v-align a.mscom-link:contains('')"
        ).each(function () {
            $store = $(this).text();
            if ($store == "") {
                $(this)
            ...
            $(this)
                ...
                .each(function () {
                    if (
                        ...
                        $(this).attr("data-player-type") == null ||
                        $(this).attr("data-player-type") == undefined
                    ) {
                        $(this).removeAttr("href");
                    }
                });
...
function loadaccordiondata() {
    try {
        ...
        $(".cp-accordion-with-control .accordionpanel").each(function () {
            ...
            i++;
            $(".cp-accordion-with-control .accordion-main-panel")
                .children()
                .eq(0)
                .trigger("click");
        });
...
function CircleGraphicsWithSideTextCall() {
    ...
    forEach(
        document.querySelectorAll(".CP-CircleGraphicsWithSlideText"),
        function (componentNode, index) {
            ...
            var leftCircleNode = componentNode.querySelector(
                ".CP-CircleGraphicsWithSlideText .left-col .circles .left-circle"
            );
            var rightCircleNode = componentNode.querySelector(
                ".CP-CircleGraphicsWithSlideText .left-col .circles .right-circle"
            );
            var crossCircleNode = componentNode.querySelector(
                ".CP-CircleGraphicsWithSlideText .left-col .circles .right-circle .cross-circle"
            );
            var leftTitleNode = componentNode.querySelector(".left-title");
            var rightTitleNode = componentNode.querySelector(".right-title");
            var barNodes = componentNode.querySelectorAll(
                ".rectangle-bar .rectangle-bar-left"
            );
                    ...
                    innerWidth > 1084
                        ...
                        (innerWidth > 768
                            ...
                            : innerWidth >= 540
                                ...
                                : 0.91); /*As per Cloud-platform viewports*/
                positioning();
                slideListNode.style.marginLeft =
                    -slideWidth * currentBarCircleIndex * 2 + "px";
            });
            forEach(barCircleNodes, function (barCircleNode, barCircleIndex) {
                barCircleNode.onclick = function () {
                    ...
                    slideListNode.style.marginLeft =
                        -slideWidth * barCircleIndex * 2 + "px";
            ...
            function circling(barCircleIndex) {
                ...
                var left = parseFloat(
                    barCircleNode.getAttribute("data-left-circle-size")
                );
                var right = parseFloat(
                    barCircleNode.getAttribute("data-right-circle-size")
                );
                var maxWidth = parseInt($(leftColNode).css("max-width"));
                var mainWidth =
                    Math.min(componentWidth * (innerWidth >= 768 ? 0.65 : 1), maxWidth) *
                    (innerWidth >= 768 ? 0.64 : 1);
                ...
                if (navigator.userAgent.search("Firefox") >= 0) {
                    var top =
                        leftWidth > rightWidth ? -(leftWidth - rightWidth) / 2 + 1 : -1;
            ...
            function baring(barCircleIndex) {
                ...
                forEach(barNodes, function (barNode, barNodeIndex) {
                    var barWidth = barCircleNode.getAttribute(
                        "data-rectangle-" + (barNodeIndex + 1) + "-size"
                    );
...
(function ($) {
    function fixButtonHeights() {
        ...
        $(".CP_CenterImageWithSideText .row-carousel .mobile-carousel ul li").each(
            function () {
...
function CircleLayersWithSideTextCall() {
    ...
    forEach(
        document.querySelectorAll(".CP_CircleLayersWithSlideText_1"),
        function (componentNode, index) {
            ...
            var labelCircleNodes = componentNode.querySelectorAll(
                ".circle-label-point"
            );
            ...
            var circleLayerSubNodes = componentNode.querySelectorAll(
                ".circle-layer-sub"
            );
            ...
            forEach(labelDownNodes, function (labelNode, i) {
                labelNode.setAttribute(
                    "data-label-active",
                    labelDownNodes.length - i - 1 == 0
                );
                labelCircleNodes[i].setAttribute(
                    "data-label-active",
                    labelDownNodes.length - i - 1 == 0
                );
                labelNode.onclick = function () {
            ...
            function setPositions() {
                ...
                if (innerWidth < 768) {
                    graphicWidth = Math.min(
                        innerWidth >= 540 ? graphicWidth : 211,
                        graphicWidth
                    );
                }
                var graphicHeight =
                    (graphicWidth * 400) / (innerWidth < 540 ? 450 : 800);
                slideListNode.style.width =
                    slideWidth * slideTextNodes.length * 2 * 1.1 + "px";
                slideListNode.style.marginLeft =
                    -slideWidth * 2 * (slideTextNodes.length - 1 - changeIndex) + "px";
                ...
                circlesNode.setAttribute(
                    "viewBox",
                    innerWidth < 540 ? "0 0 450 400" : "0 0 800 400"
                );
...
$(document).ready(function () {
    try {
        if (
            $("#CP_CenterImageWithSideText").find(".slick-carousel-mobile").length > 0
        ) {
            var dirrtl = false;
            if ($("body").hasClass("rtl")) {
                dirrtl = true;
...
function newsfeedContentHeight() {
    setTimeout(function () {
        ...
        $("#CP_NewsFeed_1 div.banner-container div")
            .closest(".banner-container")
            .css("height", maxNewsHeight);
    }, 10);
}
$(window).on("resize", function () {
    setTimeout(function () {
    ...
    setTimeout(function () {
        if ($(".hero-carousel-with-button").length > 0) {
            $(".hero-carousel-with-button").each(function () {
                var max_height = 0;
                $(this)
                    .find(".hero-carousel-button-slides")
                    .css("height", "auto");
                $(this)
                    .find(".hero-carousel-button-slides")
                    .find(".text-content")
...
// Start of the reWrite Image Carousel
...
$(document).ready(function () {
    ...
    function setTabCarousel(tabs) {
        ...
        $('.carousel-thumbnail-item[data-show="true"]').each(function (k) {
            ...
            farPositionLeft = imageTabCarouselItemWidth * (tabPosition + 1) + "px";
    ...
    $(".carousel-nav").on("click", function (dir,e) {
        var activeTab = $('.carousel-thumbnail-item[data-active="true"]');
        var nextIndex = 0;

        if ($(this).hasClass("carousel-right") || dir == "left") {
            ...
            slideCarousel("right");
            tabSelected(nextTab);
        } else if ($(this).hasClass("carousel-left") || dir == "right") {
            nextIndex = parseInt($(activeTab).attr('data-index'), 10) - 1;
            if (nextIndex < 0) {
                nextIndex = 0;
            }
    ...
    $('.carousel-thumbnails').on('keydown', function (e) {
        ...
        if (e.keyCode == 37 || e.keyCode == 38) { //Left and up arrow keypress 
            ...
            if (imageTabCarouselCount < imageTabCarouselCountTotal) { // seeing if we need carousel scrolling
                if (nextIndex < 0) {
                    nextIndex = imageTabCarouselCountTotal;
                } else if ( nextIndex > imageTabCarouselCountTotal ) {
                    nextIndex = 0;
                }
                nextTab = $('.carousel-thumbnail-item[data-index="' + nextIndex + '"]');
                $(activeTab).attr({
...
$(document).ready(function () {
    try {
        var forEach = Array.prototype.forEach.call.bind(Array.prototype.forEach);
        forEach(
            document.querySelectorAll(".cp-five-pillar-overlay-content-1"),
            function (componentNode) {
                ...
                $(document).on("keyup", itemNodes, function (event) {
                    //close pop up on escape/enter key press
                    var target = event.target ? event.target : event.srcElement;
                    if (
                        target.className.indexOf("pillar-item") >= 0 ||
                        (target.className &&
                            target.className.indexOf("pillar-close-button") >= 0)
                    ) {
                        if (
                            event.keyCode == 27 ||
                            event.charCode == 27 ||
                ...
                var itemClick = function (event) {
                    if (
                        event.target.window ||
                        event.target.className.indexOf("pillar-close-button") < 0
                    ) {
                        forEach(itemNodes, function (subItemNode, subIndex) {
                            if (
                                (innerWidth >= MOBILE &&
                                    innerWidth < TABLET &&
                                    ((activeIndex < 2 && subIndex < 2) ||
                                        (activeIndex >= 2 &&
                                            activeIndex < 4 &&
                                            subIndex >= 2 &&
                                            subIndex < 4) ||
                                        (activeIndex >= 4 && subIndex >= 4))) ||
                                (innerWidth >= TABLET &&
                                    innerWidth < DESKTOP &&
                                    ((activeIndex < 3 && subIndex < 3) ||
                                        (activeIndex >= 3 && subIndex >= 3))) ||
                                innerWidth >= DESKTOP
                            ) {
                ...
                $(".cp-five-pillar-overlay-content-1 ").each(function (e) {
                    // Fix made to keep focus on links incase pop up is disabled
                    $(this)
                        .find(".pillar-item")
                        .each(function () {
                ...
                forEach(itemNodes, function (itemNode, index) {
                    ...
                    itemNode.onkeyup = function (event) {
                        if (
                            ...
                            //updated to support all browsers
                            activeIndex = index;
                            if (!$(itemNode).hasClass("disable-popup")) {
                                itemClick(event);
                            }
...
function ContentPlacementHeight() {
    $(".cp-content-placement").each(function () {
        gridcount = $(this)
            .find(".content-placement-main")
            .attr("data-grid-count");
        if (gridcount == 2) {
            $(this)
                .find(".content-placement-col")
                .each(function () {
        ...
        if (
            (gridcount == 4 && window.matchMedia("(min-width: 540px)").matches) ||
            ((gridcount == 2 || gridcount == 3) &&
                window.matchMedia("(min-width: 768px)").matches)
        ) {
            $(this)
                .find(".content-parent")
                .addClass("cprowparent");
            $(this)
                .find(".badge-section")
                .addClass("sheight");
            $(this)
...
$(document).ready(function () {
    ...
    $(".cortana-6tabs").each(function () {
        $(".inner-tab-container .video-link")
            .find("a")
            .each(function () {
                if ($(this).text() == "") {
                    if (!$(this).hasClass("open-popup-video")) {
    ...
    $(".cp-sidevideo-with-copy").each(function () {
        $(".side-video-carousel .video-link")
            .find("a")
            .each(function () {
                if ($(this).text() == "") {
                    if (!$(this).hasClass("open-popup-video")) {
...
function mwfCarouselSR() {
    $(
        ".cp-mwf-hero-carousel .m-hero div.c-carousel-p ul>li, .cp-mwf-hero-carousel .m-hero .hero-single-slide-item"
    ).each(function () {
        $(this)
            .find(".m-hero-item .hero-c-bg ul li")
            .each(function () {
                if (
                    !$(this)
                        .find("a")
                    ...
                    $(this)
                        .closest(".hero-c-links")
                        .addClass("hero-buttons");
                } else {
                    $(this)
                        .closest(".hero-c-links")
                        .removeClass("hero-buttons");
                }
            });
    });
}
