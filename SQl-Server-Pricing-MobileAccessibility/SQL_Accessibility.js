...
// Android bug not reading expanded
...
// }
    ...
    $(".accordion-main-panel .accordion-heading").each(function () {
        ...
        if ($(this).hasClass("bg-down-arrow-black")) {
            ...
            if (androidAcc() === 'android') {
                $(this).attr("aria-label", tempText + " section is expanded");
            } 
        }
    })
    ...
    $(".accordion-main-panel .accordion-heading").on("click", function (evt) {
        ...
        if ($(this).hasClass("bg-down-arrow-black")) {
            setTimeout(function () {
                ...
                if (androidAcc() === 'android') {
                    $($ele).attr("aria-label", tempText + " section is expanded");
                }
            }, 500);
        }
    });
