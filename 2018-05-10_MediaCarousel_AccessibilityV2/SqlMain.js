...
$(document).ready(function() {
    try {
        $("table").each(function() {
            ...
            var temp;
            var evenRowBgColor = $(currentTable).attr("odd-row-bg-color");
            var oddRowBgColor = $(currentTable).attr("even-row-bg-color");
...
function openiframe() {
	...
	function closeiframe() {
                ...
                setTimeout(function() {$('.custom-popup-form').css("z-index","-1")}, 500);
              
                 
              
	}
  $(document).on('click', '.form-close-button',function(){closeiframe();});
	$(document).on('keyup',function(evt) {
		if (evt.keyCode == 27) {
			closeiframe();
		}
             ...
             var visible=0;
                ...
                if ( ($(categorySelector)[0].selectedIndex == 0) && ($(audienceSelector)[0].selectedIndex == 0) ) {
                    ...
                    $('.multiple-media-container').children('div').each(function() {
                        ...
                        var audience;
                        try {audience=$(this).attr('data-audience');
                    ...
                    $('.multiple-media-container').children('div').each(function() {
                        ...
                        var category;
                        try {category=$(this).attr('data-category');
...
answerseen=1;
       ...
       $(".answer-link a").on("click",function(){  closeQuestionare();});
	...
	try {
       ...
       windowWidth = $(window).width() + 17;
		...
		$('.cp_leftNavTab .white-tablist .tab-list .tab-listitem').each(function () {
			...
			$(this).find('.arrow-right').css({ 'border-top-width': tabHeightCal, 'border-bottom-width': tabHeightCal + 0.5 });
		});
