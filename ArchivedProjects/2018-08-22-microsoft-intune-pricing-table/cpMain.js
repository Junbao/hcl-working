...
var intraPageNavBar = function () {
    ...
    function init() {
        ...
        $('div.main-content').find('[id^=CP_]').each(function () { $componentIDs.push(this.id) });
...
function UHFResourcesMenuHighlighter() {
    ...
    if ($(".cp_subtab").length > 0) {
        ...
        $('#uhf-g-nav > a').removeClass("current");
        cpSubTabNav.find(".tabs").each(function () {
            if ($(this).attr("data-resources") == "resources") {
                $('#uhf-g-nav a.c-uhf-nav-link').each(function () {
...
$(document).ready(function () {
    ...
    try {
        ...
        $('#uhf-g-nav a').each(function (index, value) {
    ...
    $('#uhf-g-nav a').each(function (index, value) {
        ...
        if (uhfAnchorValue.indexOf("/cloud-platform/") > -1) {
            ...
            if ((pageFromUrl.toString().toLowerCase() != "" && cpPageName.toString().toLowerCase() != "") && (pageFromUrl.toString().toLowerCase() == cpPageName.toString().toLowerCase())) {
                setTimeout(function () {
                    activeLinkObjId = $(value).attr('id');
                    if ($('.overflow-menu').find('#' + activeLinkObjId).length > 0) {
                        $("#" + activeLinkObjId).closest("#overflow-menu .c-uhf-menu").addClass('currentParent');
                        $("#" + activeLinkObjId).parents('.c-uhfh.c-sgl-stck .overflow-menu-list li.nested-menu').addClass('currentSubParent');
                    }
                    else {
                        $("#overflow-menu .c-uhf-menu").removeClass('currentParent');
                        $("#" + activeLinkObjId).parents('.c-uhfh-gnav li.nested-menu').removeClass('currentSubParent');
                        $("#" + activeLinkObjId).closest(".c-uhf-menu").addClass('currentParent');
                    }
                }, 200);
            }
            ...
            $(".cp-five-pillar-overlay-content-1 ").each(function (e) { // Fix made to keep focus on links incase pop up is disabled
                $(this).find(".pillar-item").each(function () {
                    ...
                    if (!$(this).hasClass("disable-popup")) {
                        ...
                        $(this).find(".pillar-content").find("a").attr("tabindex", "0");
                    }

                });

            });
            $(".cp-five-pillar-overlay-content-1 .pillar-item .pillar-popup").each(function () {
                $(this).find("a").attr("tabindex", "0");
                $(this).find("a.pillar-close-button").on("keydown", function (e) {
                    if (e.keyCode == 9) {
                        $(".cp-five-pillar-overlay-content-1 .pillar-item[data-active='true'] .pillar-popup .body-alt>a").focus();
                        e.preventDefault();
                    }
                });
                $(this).find(".body-alt a:last-child").on("focus", function (e) {
                    $(".body-alt a:last-child").on("keydown", function (e) {
                        if (e.keyCode == 9) {
                            e.preventDefault();
                            $(".cp-five-pillar-overlay-content-1 .pillar-item[data-active='true'] .pillar-popup a.pillar-close-button").focus();
                ...
                $(this).find("a.pillar-close-button").on("keydown", function (e) {
                    if (e.shiftKey && e.keyCode == 9) {
                        $(".cp-five-pillar-overlay-content-1 .pillar-item[data-active='true'] .pillar-popup .body-alt a:last-child").focus();
                        e.preventDefault();
                    }
                });
                $(this).find(".body-alt a:last-child").on("keydown", function (e) {
                    if (e.shiftKey && e.keyCode == 9) {
                        $(".cp-five-pillar-overlay-content-1 .pillar-item .pillar-popup a.pillar-close-button").focus();
                        e.preventDefault();
                    }
                });
            });
            $(".cp-five-pillar-overlay-content-1 .pillar-item").each(function () {

                $(this).find(".pillar-content a.c-call-to-action").on("keypress", function (e) {
                    $(".cp-five-pillar-overlay-content-1 .pillar-item .pillar-content .link a.c-call-to-action").removeClass("active");
                    if (e.keyCode == 13) {
                        $(this).addClass("active");

                    }
                });
                $(this).find("a.pillar-close-button").on("keypress", function (e) {
                    if (e.keyCode == 13) {
                        setTimeout(function () {
                            $(".cp-five-pillar-overlay-content-1 .pillar-item .pillar-content .link a.c-call-to-action.active").focus();
                            e.preventDefault();
                            $(".cp-five-pillar-overlay-content-1 .pillar-item .pillar-content .link a.c-call-to-action.active").removeClass("active");
                        }, 300);
...
/*CP_MWF_Casestudy*/
$(window).load(function () {
    if (!$(".main-content .cp-mwf-casestudy-1 .m-rich-content-block .body-content .image-div").hasClass("show")) {
        $(".main-content .cp-mwf-casestudy-1 .m-rich-content-block .body-content").each(function () {
            $(this).find(".content-div").removeAttr("data-grid");
            $(this).find(".content-div").css("width", "100%");
        });
    }

    if ($(".cp-mwf-casestudy-1 .m-rich-content-block .body-content .image-div").hasClass("show")) {
        $(".cp-mwf-casestudy-1 .m-rich-content-block .body-content").each(function () {
            $(this).find(".content-div").removeAttr("data-grid");
            $(this).find(".content-div").attr("data-grid", "col-10");
            $(this).find(".content-div").css("padding-left", "20px");
...
$(document).ready(function () {
    $(".cp-mwf-casestudy-1 .m-rich-content-block .case-details-row").each(function () {
        if (!$(this).children().hasClass("show")) {
            $(this).remove();
        }
    });
    if ($(".cp-mwf-casestudy-1 .m-rich-content-block .body-content .image-div").hasClass("show")) {
        $(".cp-mwf-casestudy-1 .m-rich-content-block").each(function () {
            $(this).find(".body-content").removeClass("border-right");
        });
    }
    if ($(".rtl .cp-mwf-casestudy-1 .m-rich-content-block .body-content .image-div").hasClass("show")) {
        $(".rtl .cp-mwf-casestudy-1 .m-rich-content-block .body-content").each(function () {
            $(this).find(".content-div").css("padding-right", "20px");
            $(this).find(".content-div").css("padding-left", "0px");
        });
    }
...
$(document).ready(function () {
    try {
        cpSubTabActiveColumns();
        setSubTab();
        $(document).on("click", ".cp-tabs-container .cp-tab", function (e) {
            e.preventDefault();
            if (!$(this).hasClass("active")) {
                var tabindex = $(this).index();
                var tabtext = $(this).text();
                $(this).parents().closest(".cp-sub-tabs-holder").addClass("cp-current-sub-tab");
                $(this).parents(".cp-tabs-container").siblings().find('.cp-selected-tab').children().text(tabtext);
                ...
                if (window.matchMedia("(max-width: 539px)").matches) {
                    $(this).hide();
                    $(this).siblings().show();
                    $(".cp-tabs-container").slideToggle("slow");
                    $(".cp-tabs-mobile-container .cp-selected-tab").toggleClass("active");
                }
                else {
                    $(this).show();
                    $(this).siblings().show();
                    $(".cp-tabs-container").css("display", "block");
                }


                $(".cp-current-sub-tab").find(".cp-subtabs-data-container").children().removeClass("active");
                $(".cp-current-sub-tab").find(".cp-subtabs-data-container").children().eq(tabindex).fadeOut('fast', function () {
                    $(".cp-current-sub-tab").find(".cp-subtabs-data-container").children().eq(tabindex).siblings().css("display", "none");
                });
                $(".cp-current-sub-tab").find(".cp-subtabs-data-container").children().eq(tabindex).fadeIn('slow', function () {
                    $(".cp-current-sub-tab").find(".cp-subtabs-data-container").children().eq(tabindex).addClass("active");
                });
                $(".cp-current-sub-tab").removeClass("cp-current-sub-tab");
            }
            updateSubTabsUrl();
        });
        $(document).on("click", ".cp-tabs-mobile-container .cp-selected-tab", function (e) {
            e.preventDefault();
            $(this).toggleClass("active");
            $(".cp-tabs-container").slideToggle("slow");
...
function setSubTab() {
    if ($(".cp-event-subtabs").length) {
        if (window.matchMedia("(min-width: 540px)").matches) {
            $(".cp-tabs-container").show();
            $(".cp-tabs-container .cp-tab").show();
        }
        else {
            $(".cp-tabs-container").hide();
            $(".cp-tabs-mobile-container .cp-selected-tab").removeClass("active");
            $(".cp-tabs-container .cp-tab.active").hide();
        }
    }
}
...
function cpSubTabActiveColumns() {
    $('.cp-event-subtabs').each(function () {
        var gridcount = $(this).attr('data-grid-count');
        if (gridcount == 3) {
            $(this).find('.cp-tabs .cp-tab').each(function () {
...
$(window).resize(function () {
    ...
    else { $(".cp-event-subtabs .cp-tab span").css('height', 'auto'); }
});
...
function eventSubtabsheight() {
    try {
        setTimeout(function () {
            var max_height = 0;
            $(".cp-tab span").css("height", "auto");
            $(".cp-event-subtabs .cp-tabs").find(".cp-tab").each(function () {

                var curheight = $(this).find("span").outerHeight();
                max_height = max_height > curheight ? max_height : curheight;

            });
            $(".cp-event-subtabs .cp-tab span").css("height", max_height);
        }, 100);
    } catch (err) {
...
function updateSubTabsUrl() {
    var activeTab = $(".cp-event-subtabs").find(".cp-tabs-container").find(".cp-tabs .cp-tab.active").attr("data-deeplinkid").toLowerCase();
...
function loadSubtabTab() {
    ...
    setTimeout(function () {
        if (url.indexOf("#") != -1) {
            ...
            var topvalue = 0;
            var addheight = 0;
            if ($(".cp-event-subtabs").length > 0) {
                if ($(".cp-pageTitle.clone").length > 0) {
                    addheight = $(".cp-pageTitle").outerHeight();
                }
                $(".cp-event-subtabs .cp-tabs-container .cp-tabs").find(".cp-tab").each(function () {
                    ...
                    if (deeplinkid != "" || deeplinkid != undefined || deeplinkid != null) {
                        ...
                        var currentTab = $(this);
                        topvalue = $(this).parents().closest(".cp-event-subtabs").offset().top;
...
function setHighlighterHeight() {
    try {
        ...
        $(".cp-event-table .cp-table .merge").each(function () {
...
$(document).ready(function () {
    try {
        ...
        setTimeout(function () {
            ...
            if (url.indexOf("#") > 0) {
                ...
                deeplinkvalue = deeplinkvalue[1].toLowerCase();
                if ($(".cp-event-subtabs").length > 0) {
                    $(".cp-event-subtabs .cp-tabs-container .cp-tabs .cp-tab").each(function () {
                ...
                if (subTabDeeplink == 0) {
                    ...
                    if ($(".cp-pageTitle.clone").length > 0) {
                        addStickyHeight = $(".cp-pageTitle").outerHeight();
    ...
    $('.cp-event-subtabs .cp-tabs-container .cp-tab').each(function () {
        if (!$(this).hasClass('active')) {
    ...
    $(document).on('click', '.cp-event-subtabs .cp-tabs-container .cp-tab', function (e) {
    ...
    $(document).on('keydown', '.cp-event-subtabs .cp-tabs-container .cp-tab', function (e) {
        ...
        if (e.keyCode == 37) {
            ...
            _tablength = $(".cp-event-subtabs .cp-tabs-container .cp-tab").length;
            _currentDataIndex = $(_currentEle).index();
            if (_currentDataIndex == 0) {
                $(".cp-event-subtabs .cp-tabs-container .cp-tab:last").trigger('click').focus();
            }
            $(this).prev().focus();
        }
        ...
        if (e.keyCode == 39) {
            // disableScroll();
            _currentEle = e.currentTarget;
            _tablength = $('.cp-event-subtabs .cp-tabs-container .cp-tab').length - 1;
            _currentDataIndex = $(_currentEle).index();
            if (_currentDataIndex == _tablength) {
                $(".cp-event-subtabs .cp-tabs-container .cp-tab:first").trigger('click').focus();
            }
            $(this).next().focus();
