...
$(document).ready(function () {
    ...
    function carouselArrowFollow() {
        ...
        setTimeout(function () {
            ...
            console.log("sectionWidth - " + sectionWidth + " elmLeft - " + elmLeft + " elmWidth - " + elmWidth + " tabCarouselWidth - " + tabCarWidth +
                " arrow LeftSpace - " + arrowLeftSpace + " arrowAlign - " + arrowAlign);
